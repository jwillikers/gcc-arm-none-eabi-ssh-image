...
[source,sh]
----
➜ podman run --rm -p 2222:22 --volume "$HOME":/home/user:Z -dt --name gnu-arm-embedded-ssh quay.io/jwillikers/gnu-arm-embedded-ssh
----
...
[source,sh]
----
➜ ~/Projects/gnu-arm-embedded-ssh-image/gnu-arm-embedded-ssh-image.sh
----
