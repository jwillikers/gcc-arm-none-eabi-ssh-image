...
buildah run "$CONTAINER" /bin/sh -c 'microdnf install -y clang-tools-extra cmake gdb gcc-arm-none-eabi gcc-arm-none-eabi-c++ ninja-build python3 python3-pip python3-wheel python-unversioned-command --nodocs --setopt install_weak_deps=0'
